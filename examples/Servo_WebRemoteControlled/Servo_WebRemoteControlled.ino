/*
  ...
  Based upon example from Rui Santos (Random Nerd Tutorials) and DroneBot Workshop
...
// Network credentials
const char* ssid     = "King";  // YOURSSID
const char* password = "A7galaxy";  // YOURPW
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Get JQuery
            client.println("<script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js\"></script>");
